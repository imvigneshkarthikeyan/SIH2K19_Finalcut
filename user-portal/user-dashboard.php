...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    <a class="navbar-brand" href="#"><img src="img/logo.png" width="125"></a>
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item" onclick="print()">
       ...
       <li class="nav-item">
        <a class="nav-link" href="http://localhost/d/voice-bot/"> Virtual assistant<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="stop()">Close</button>
              </div>
            </div>
          </div>
        </div>
